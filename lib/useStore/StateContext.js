...
var useStateStore = function (Context) {
    ...
    var onStateChange = function (newState, callback, innerState) {
        ...
        if (!isEqual_1.default(innerState, newState)) {
            callback(newState);
        }
    };
    var stateKeyValueChanged = function (key, value, innerState) {
        if (innerState === void 0) { innerState = state; }
        return utils_1.stateKeyChanged(innerState, key, value);
    };
    ...
    var onStateObjectChange = function (passedState, callback, innerState) {
        ...
        Object.keys(passedState).forEach(function (key) {
            var _a;
            if (!isEqual_1.default(get_1.default(innerState, key), get_1.default(passedState, key))) {
                updatedState = __assign(__assign({}, updatedState), (_a = {}, _a[key] = get_1.default(passedState, key), _a));
            }
        });
        if (!isEqual_1.default(innerState, updatedState)) {
