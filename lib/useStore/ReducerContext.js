...
var useReducerStore = function () {
    var _a = react_1.useContext(context_1.ReducerContext), state = _a.state, dispatch = _a.dispatch;
...
var useReducerSelector = function (selector) {
    var state = exports.useReducerStore().state;
    return selector(state);
};
exports.useReducerSelector = useReducerSelector;
var ReducerProvider = function (_a) {
    var children = _a.children, reducer = _a.reducer, _b = _a.initialState, initialState = _b === void 0 ? context_1.initialContextState : _b;
    ...
    return (react_1.default.createElement(context_1.ReducerContext.Provider, { value: { state: contextValue.state, dispatch: contextValue.dispatch } }, children));
};
exports.ReducerProvider = ReducerProvider;
var withReducerProvider = function (reducer, initialState
// eslint-disable-next-line react/display-name
) {
    if (initialState === void 0) { initialState = context_1.initialContextState; }
    return function (Component) { return function (props) { return (react_1.default.createElement(exports.ReducerProvider, { reducer: reducer, initialState: initialState },
