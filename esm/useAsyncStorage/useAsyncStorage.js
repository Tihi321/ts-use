...
export var useAsyncStorage = function (key, initialState) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, AsyncStorage.setItem(key, jsonValue)];
                case 1:
                    _a.sent();
                    setData(value);
                    return [3 /*break*/, 3];
                case 2:
                    e_1 = _a.sent();
                    console.log("Error saving value", e_1);
                    return [3 /*break*/, 3];
    ...
    var getData = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    e_2 = _a.sent();
                    console.log("Error reading value", e_2);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
